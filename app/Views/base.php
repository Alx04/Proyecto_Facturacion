...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?=base_url()?>/plantilla/dist/img/logo.png" alt="Logo facturación electronica" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Facturación Electrónica</span><br>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?=base_url()?>/plantilla/dist/img/usuario.png" class="elevation-2" alt="User Image" style="width: 50px;">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021<a href="https://jrtec.cl"> JRTEC Proyecto Factura</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
